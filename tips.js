...
(function() {
    ...
    const michaelsTips = ["bluebella", "ukantango", "wobwobwob", "billy no mates"];
    const chrisTips    = ["betty's tiara", "the great escape", "triggerman", "grand harbour"];
    const peterTips    = ["taygar", "masonbrook meadow","brave bob", ""];
